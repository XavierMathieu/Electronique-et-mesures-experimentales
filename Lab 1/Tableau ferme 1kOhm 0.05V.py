...
caption = """
Figure 8: Distribution des valeurs de tensions captées par 
le module d'aquisition sur une résistance sans alimentation 
(i.e. seulement la résistance) à une résolution de ±0,05V.
"""

plt.text(0.1, 0.20, caption, fontsize='large', verticalalignment='top', transform=plt.gcf().transFigure)

plt.show
#plt.savefig(rf"C:/DATA/Université/Électronique et mesures/Lab 1/Circuit_fermé_1kOhm_0.05V.pdf")
# %%
